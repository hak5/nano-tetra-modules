...
registerController('wps_OptionsController', ['$api', '$scope', '$rootScope', function($api, $scope, $rootScope) {
		...
		$scope.reaverAdvancedOptions = {
			option1 : { check : false, val : '1'},
			option2 : { check : false, val : '60'},
			option3 : { check : false, val : '100'},
			option4 : { check : false, val : '0'},
			option5 : { check : false, val : '5'},
			option6 : { check : false, val : '0.20'},
			option7 : { check : false, val : '1:10'},
			option8 : { check : false, val : '1'}
		};

		$scope.bullyAdvancedOptions = {
			option1 : { check : false, val : '7'},
			option2 : { check : false, val : '43'},
			option3 : { check : false, val : '12345'},
			option4 : { check : false, val : '3'},
			option5 : { check : false, val : '2'},
			option6 : { check : false, val : '0,1'},
			option7 : { check : false, val : '5,1'}
		};
